# Functional Python [![](https://github.com/nmpatterson22/functional-python/workflows/tests/badge.svg)](https://github.com/nmpatterson22/functional-python/actions?query=workflow%3Atests)
